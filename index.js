...
function showButtonnightsalone(fake$bill)() {
  let nightsalone(fake$bill) = "<audio controls><source src=\"/assets/music/11.- 'Bull's-eye'/2 -Nights Alone (fake $ Bill).mp3\" type=\"audio/mp3\"></audio>";
  document.getElementById(nightsalone(fake$bill)).innerHTML = nightsalone(fake$bill);
}
